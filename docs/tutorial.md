...
{: .highlight } 
GWAS summary statistics come in various formats. To convert them to the GCTA-COJO format, you can refer to this third-party [tutorial](https://github.com/zlintian/SBayesRC_pipeline?tab=readme-ov-file#cojo-format).
...
The analysis takes approximately 3 minutes, processing chromosomes 1 through 22 sequentially. 
